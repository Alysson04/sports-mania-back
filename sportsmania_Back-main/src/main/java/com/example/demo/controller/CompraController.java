...
public class  CompraController {
    ...
    public CompraRequestDTO getCompraByCnpj (@PathVariable ("cnpj") String cnpj){
        ...
        public ResponseEntity<CompraRequestDTO> getCompraByNome(@PathVariable Administrador administrador) throws ResourceNotFoundException {
            CompraRequestDTO compraRequestDTO = compraService.findCompraByAdministrador(administrador);
            return ResponseEntity.ok(compraRequestDTO);
        }
